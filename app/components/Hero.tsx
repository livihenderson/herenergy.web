    ...
    <section className="relative h-[110lvh] md:h-[100svh] min-h-[100lvh] md:min-h-[760px] overflow-hidden isolate bg-bone">
      ...
      <div className="absolute inset-x-0 top-0 pt-20 md:pt-28 pb-8 px-5 md:px-6 flex flex-col items-center text-center z-20">
        ...
        <h1 className="leading-[0.85] flex flex-col items-center overflow-visible">
          ...
          <span className="rise px-2 delay-4 block font-serif italic font-light text-[22vw] md:text-[11vw] tracking-[-0.02em] -mt-[2vw] md:-mt-[0.02em] leading-[1.3] pb-[0.4em] overflow-visible bg-clip-text text-transparent bg-[linear-gradient(90deg,#3a1320_0%,#3a1320_44%,#c63a3a_50%,#fbe4d6_56%,#fbe4d6_100%)] drop-shadow-[0_2px_18px_rgba(0,0,0,0.35)]">
            energy
          </span>
        </h1>
